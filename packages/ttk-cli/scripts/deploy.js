...
function createMainJsFile() {
    ...
    content = content.replace('window.TTK = ttk;', `
        window.TTK = ttk;
        ttk.init({
            baseUrl: "",
    ...
    fs.writeFileSync(path.resolve(coreDirectory, isDev ? 'ttk-main.js' : 'ttk-main.min.js'), content);
...
function createHtmlFile() {
    ...
    if (isDev) {
        html = html.replace('require.min.js', 'require.js').replace('ttk-main.min.js', 'ttk-main.js')
    }
