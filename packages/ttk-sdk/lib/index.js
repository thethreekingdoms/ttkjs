...
var _appLoader = _interopRequireDefault(require("@ttkjs/app-loader"));

var _utils = _interopRequireDefault(require("@ttkjs/utils"));

var _metaEngine = _interopRequireDefault(require("@ttkjs/meta-engine"));
...
var Hoc,
    ...
    context = _metaEngine.default.contextManager; //Initialize ttkjs environment
...
var createAppElementInternal = function createAppElementInternal(appName, appProps) {
  return function (props) {
    return _react.default.createElement(_reactRedux.Provider, {
      store: store
    }, _react.default.createElement(_appLoader.default.AppLoader, (0, _extends2.default)({
      name: appName
    }, appProps, props)));
  };
};
...
function createAppElement(appName, appProps) {
  ...
  if (Hoc) {
    return _react.default.createElement(Hoc, null, _react.default.createElement(Internal, null));
  } else {
    return _react.default.createElement(Internal, null);
  }
...
function _render() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(appName, targetDomId, disableRoute) {
    var props,
        appNameNoQuery,
        _args2 = arguments;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            if (Hoc) {
              (0, _reactDom.render)(_react.default.createElement(Hoc, null, _react.default.createElement(_reactRedux.Provider, {
                store: store
              }, _react.default.createElement(_appLoader.default.AppLoader, (0, _extends2.default)({
                name: appName
          ...
          case 8:
            if (Hoc) {
              (0, _reactDom.render)(_react.default.createElement(Hoc, null, _react.default.createElement(_reactRedux.Provider, {
                store: store
              }, _react.default.createElement(_metaEngine.default.rootElement, (0, _extends2.default)({
                appName: appName
              }, props)))), document.getElementById(targetDomId));
            } else {
              (0, _reactDom.render)(_react.default.createElement(_reactRedux.Provider, {
